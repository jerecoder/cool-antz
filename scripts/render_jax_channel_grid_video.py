...
class ChannelGridRenderer:
    """Build 1600x800 byte-channel frames without ant/food/hub markers."""
    ...
    def frame_size(self) -> tuple[int, int]:
        return (self.left_size + self.panel_size * 2, self.panel_size * 2)
    ...
    def frame(self, byte_grid: np.ndarray) -> np.ndarray:
        ...
        right = Image.new("RGB", (self.panel_size * 2, self.panel_size * 2), (0, 0, 0))
        for index, panel in enumerate(self._smoothed_bits):
            ...
            x_pos = (index % 2) * self.panel_size
            y_pos = (index // 2) * self.panel_size
