...
La cuarta limitación es de trazabilidad negativa. Algunas ramas importantes, como laberintos y cuadernos laterales de prueba de estrés, quedaron mejor representadas por código, commits, videos diagnósticos y metadatos que por evaluaciones finales comparables. En este informe se incluyen porque explican decisiones del proyecto, pero no se usan como evidencia cuantitativa de desempeño. El video W\&B de laberinto y la prueba 100x100 muestran comportamiento, no una métrica de forrajeo cooperativo resuelta.
