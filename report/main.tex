...
La contribución honesta del trabajo no es ``resolvimos comunicación emergente''. Es más precisa: construimos un entorno de forrajeo multi-agente con memoria externa, identificamos qué cambios desbloquean cada escala, alcanzamos una solución 25x25 bajo movimiento muestreado y resultados muy fuertes en 50x50 bajo crítico espacial, y mostramos que en 250x250 el retorno moldeado puede engañar si no se mide entrega real.
...
\begin{enumerate}
    ...
    \item Decidir si se rerunnea el flujo de laberintos o si queda explícitamente fuera del conjunto empírico final.
\end{enumerate}
