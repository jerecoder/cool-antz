...
\caption{Layout 50x50 generado desde \run{maze_exploration_curriculum.json} con el generador real de laberintos del entorno. No es un rollout ni una métrica de éxito: muestra la geometría que la rama podía producir, mientras que el resultado cuantitativo comparable no quedó preservado.}
